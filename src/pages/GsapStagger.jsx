    ...
    <main>
      ...
      <div className="mt-20">
        <div className="flex gap-5">
          <div className="w-20 h-32 bg-indigo-200 rounded-md stagger-box" />
          <div className="w-20 h-32 bg-indigo-300 rounded-md stagger-box" />
          <div className="w-20 h-32 bg-indigo-400 rounded-md stagger-box" />
          <div className="w-20 h-32 bg-indigo-500 rounded-md stagger-box" />
          <div className="w-20 h-32 bg-indigo-600 rounded-md stagger-box" />
          <div className="w-20 h-32 bg-indigo-700 rounded-md stagger-box" />
          <div className="w-20 h-32 bg-indigo-800 rounded-md stagger-box" />
        </div>
      </div>
    </main>
  );
